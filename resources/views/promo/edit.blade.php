...
@section('content-header')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('promo.index') }}"><i class="fa fa-dashboard"></i> Promo</a></li>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        {!! Form::text('kode', $promo->kode, array('placeholder' => 'Kode Promo','class' =>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::date('expire_date', \Carbon\Carbon::now(),['class' =>'form-control date','id'=>'expireDate']) !!}
