...
//        $roles = Role::all();
    ...
    public function create()
    {
        ...
        $permit = Permission::pluck('name','id')->all();
        return view('roles.create',compact('permissions','permit'));
    }
...
//        }
    ...
    public function edit($id)
    {
        ...
        return view('roles.edit',compact('role','permission','rolePermissions','permit'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('roles.index')
            ->with('Sukses','Role deleted successfully');
    }
}
