        ...
        <div class="col-xs-6">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Tambah Jenis Ukuran</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                {!! Form::open(array('route' => 'jenis-ukuran.store','method'=>'POST')) !!}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::number('harga',0,['placeholder' => 'Harga','class' => 'form-control','id'=>'harga'])
                         !!}
                    </div>
